...
    // === OYUN VERİTABANI (Toplam 25 Ülke) ===
// === GÜNCELLENMİŞ OYUN VERİTABANI (Toplam 25 Ülke) ===
    const gameData = [
...
        } else {
            // DÜZELTME: Buradaki 'playerPawn' eksikliği hatası giderildi
...
        }
        if (btnHintFood) btnHintFood.disabled = (playerTokens < 10);
        if (btnHintColors) btnHintColors.disabled = (playerTokens < 10);
    }
...
        // DÜZELTME: Buradaki 'const' eksikliği hatası giderildi
...
    // Buton Sesi Yardımcı Fonksiyonu
...
        // Toplam seviye sayısını dinamik olarak ayarla
...
        // musicMenu.volume = e.target.value / 100;
    });
...
        sfxButtonClick.volume = effectVolume;
    });
